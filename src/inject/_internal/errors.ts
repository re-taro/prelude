...
export const ErrorInvalidGlobalInjector = "Global namespace conflict. Default injector is not a inject injector.";
export const ErrorBadUse = "Can only call `use` with a molecule, interface or scope";
